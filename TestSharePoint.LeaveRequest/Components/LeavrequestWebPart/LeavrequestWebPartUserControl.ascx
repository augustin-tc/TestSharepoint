...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeavrequestWebPartUserControl.ascx.cs" Inherits="TestSharePoint.LeaveRequest.Components.LeavrequestWebPart.LeavrequestWebPartUserControl" %>
<div id="divLeaveRequest">
<h3 id="titleLeaveRequest" runat="server"></h3>
<div>
